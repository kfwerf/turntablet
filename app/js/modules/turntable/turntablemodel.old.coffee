define [ "jquery", "radio", "modules/abstract/voicecancellation" ], ( $, radio, VoiceCancellation ) ->
	class TurntableModel
		constructor: ( @_controllerTurntable ) ->

			@_eventPrefix = @_controllerTurntable._eventPrefix
			@_audioCore = @_controllerTurntable._audioCore

			@voiceCancellation = new VoiceCancellation @_audioCore
			
			@_audioFile = "audio/19 - Love Will Tear Us Apart.mp3"
